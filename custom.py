...
via_region_file = "via_region_data.json"
############################################################
#  Configurations
############################################################
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("handwriting", 1, "handwriting")
        ...
        annotations1 = json.load(open(os.path.join(dataset_dir, via_region_file)))
        # print(annotations1)
        ...
        for a in annotations:
            ...
            self.add_image(
                "handwriting",  ## for a single class just add the name here
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "handwriting":
