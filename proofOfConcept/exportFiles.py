...
image_template_string += service_context + service_id + service_profile + '} } } ] }'

d = json.dumps(image_template_string)
...
def exportManifest(urls):
  ...
  for url in urls:
      ...
      image['images'][0]['resource']['@id'] = img_url + '/full/full/0/default.jpg'
